...
class SeveralCrimeHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
    ...
    SeveralCrimeHolder(LayoutInflater inflater, ViewGroup parent, Activity activity, Fragment fragment) {
        super(inflater.inflate(R.layout.list_item_police_crime, parent, false));

        mTitleTextView = itemView.findViewById(R.id.crime_title);
        mDateTextView = itemView.findViewById(R.id.crime_date);
        mCrimeSolvedImageView = itemView.findViewById(R.id.several_crime_solved);
    ...
    void bind(Crime crime) {
        ...
        mDateTextView.setText(mCrime.getDateString(context)+" в "+mCrime.getTimeString(context));
